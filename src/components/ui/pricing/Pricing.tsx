...
const PricingComponent = ({ userPlan }: { userPlan?: string }) => {
  const [isAnnual, setIsAnnual] = useState(false);
  const isLoggedIn = !!userPlan || userPlan === "FREE";
                            ...
                            <div className="p-8">
                                ...
                                {plan.stripePlan ? (
                                    userPlan === plan.stripePlan ? (
                                        ...
                                        <button
                                        className={`w-full py-3 rounded-lg font-made-outer font-bold mb-8 transition-all duration-300 border border-green-500/40 text-green-400 bg-green-500/10 cursor-default`}
                                        disabled
                                        >
                                        Current Plan ✓
                                        </button>
